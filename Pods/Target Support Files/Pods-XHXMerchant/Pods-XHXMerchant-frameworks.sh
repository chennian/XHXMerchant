...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/APJTextPickerView/APJTextPickerView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PGActionSheet/PGActionSheet.framework"
