    ...
    func strokeChart() {
        ...
        for value in self.yValues {
            ...
            if self.barWidth != nil && self.barWidth > 0 {
                ...
                let position1 = CGFloat(index) * self.xLabelWidth + self.yChartLabelWidth
                let position2 = self.chartMargin + (self.xLabelWidth / 2 - self.barWidth / 2)
                barXPosition = position1 + position2
            } else {
