...
class XTotalEarningsListHeaderCell: SNBaseTableViewCell {
    ...
    var more = UIButton().then{
        ...
        $0.imageEdgeInsets = UIEdgeInsets(top: 0, left: 0, bottom: 0, right: fit(-280))
//        $0.titleEdgeInsets = UIEdgeInsets(top: 0, left: 0, bottom: 0, right: fit(30))
        $0.isEnabled = false
