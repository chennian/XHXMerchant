//
//  XOperationFlowController.swift
//  XHXMerchant
//
...
class XOperationFlowController: SNBaseViewController {
    ...
    func getData(){
        SNRequest(requestType: API.flowTeam(role: "2"), modelType: [FlowTeamModel.self]).subscribe(onNext: {[unowned self] (result) in
            switch result{
...
extension XOperationFlowController:UITableViewDelegate,UITableViewDataSource{
