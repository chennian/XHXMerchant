...
class XAddMerOpenController: SNBaseViewController {
...
extension XAddMerOpenController:UITableViewDelegate,UITableViewDataSource{
...
extension XAddMerOpenController : UIImagePickerControllerDelegate,UINavigationControllerDelegate{
...
extension  XAddMerOpenController: TOCropViewControllerDelegate{
