//
//  XAddMerBaseInfoController.swift
//  XHXMerchant
//
...
class XAddMerBaseInfoController: SNBaseViewController {
...
extension XAddMerBaseInfoController:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row == 0 {
            ...
            self.fieldCell = cell
            fieldCell.registNameField.text = XKeyChain.get(PHONE)
            fieldCell.registNameField.isEnabled = false
    ...
    func verifyValue(){
        ...
        self.navigationController?.pushViewController(XAddMerLinceseInfoController(), animated: true)
...
extension XAddMerBaseInfoController : UIImagePickerControllerDelegate,UINavigationControllerDelegate{
...
extension  XAddMerBaseInfoController: TOCropViewControllerDelegate{
