...
class StepOne: NSObject, NSCoding {
    ...
    init(_ accountName: String,_ legalName: String,_ idCard: String,_ emergencyContact: String,_ emergencyContactPhone: String,_ email: String) {
        super.init()
